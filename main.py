...
def transaction(identity, amount, choice):  # choice 1 for deposit; choice 2 for withdraw
    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            ...
            if choice == 2 and balance - amount < 5000:  # Minimum balance 5000
                return -1
            else:
                if choice == 1:
                    balance += amount
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome To People's Bank")
        p1 = PhotoImage(file='user 123.gif')
        window.iconphoto(True, p1)
        window.configure(background="#023047")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#ffa200", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#ffa200", disabledforeground="#a3a3a3",
...
class Error:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file="icons8-error-100.gif")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#ffa200")
        ...
        global Label2
        Label2 = tk.Label(Canvas1, background="blue", disabledforeground="#a3a3a3", foreground="#000000")
        Label2.place(relx=0.067, rely=0.283, height=181, width=233)
        global _img0
        _img0 = tk.PhotoImage(file="sodapdf-converted.gif")
        ...
        global _img1
        _img1 = tk.PhotoImage(file="user transformed.gif")
        ...
        global _img2
        _img2 = tk.PhotoImage(file="Screenshot_2023-10-22_122457-transformed.gif")
        ...
        global _img3
        _img3 = tk.PhotoImage(file="sodapdf-converted (1).gif")
        ...
        global admin_img
        admin_img = tk.PhotoImage(file="Screenshot_2023-10-22_123736-transformed.gif")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        Label2.place(relx=0.067, rely=0.283, height=181, width=233)
        global _img0
        _img0 = tk.PhotoImage(file="user 123.gif")
        Label2.configure(image=_img0)
        ...
        global customer_img
        customer_img = tk.PhotoImage(file="customer.gif")
...
class deleteAdmin:
    ...
    def delete_admin(self, admin_id, password):
        if admin_id == "pradeep" or admin_id == admin_idNO:
            Error(Toplevel(self.master))
